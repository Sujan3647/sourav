...
export default function Footwear({ addToCart }) {
  const [products, setProducts] = useState([]);

  useEffect(() => {
    fetch('/data/Footwear.json')
      .then((res) => res.json())
      .then((data) => setProducts(data))
      .catch((err) => console.error("Failed to load footwear products:", err));
  }, []);

  return (
    <div className="mb-10 animate-fade-in">
      <h2 className="text-xl font-bold text-indigo-700 mb-3">Footwear</h2>
