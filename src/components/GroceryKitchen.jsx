...
export default function GroceryKitchen({ addToCart }) {
  const [products, setProducts] = useState([]);

  useEffect(() => {
    fetch("/data/GroceryKitchen.json") // ✅ Points to public/data
      .then((res) => res.json())
      .then((data) => setProducts(data))
      .catch((err) => console.error("Failed to load GroceryKitchen.json:", err));
  }, []);

  return (
    <div className="mb-10">
      <h2 className="text-xl font-bold text-indigo-700 mb-3">Grocery & Kitchen</h2>
